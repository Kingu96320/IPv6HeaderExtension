...
class Worker(multiprocessing.Process):
	...
	def run(self):
		...
		if checkip.is_valid_host(dest):
			...
			dest=resolved
		if self.IPv6_scope_defined==True or checkip.is_valid_ipv6(dest):
...
def main():
	...
	parser = argparse.ArgumentParser(description='An IPv6 port/network scanner. It can be combined with other modules of the framework.')
